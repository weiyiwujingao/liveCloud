...
class Rs_user extends CActiveRecord
{
   ...
   /*auther by yuexl
	...
	public function addUser($username,$sex,$password,$userdesc,$isadmin,$cid,$userid,$user_name,$nick_name,$addtime,$classid,$check){
		 $data = array(
					'username' => $username,
		            'cid'=>$cid,
					'sex' => $sex,
	 ...
	 * description:修改用户信息
	 * */
	public function modUser($id,$username,$sex,$password,$userdesc,$isadmin,$cid,$userid,$user_name,$nick_name,$addtime,$classid,$check){
			 $data = array(
			        'username' => $username,
		            'cid'=>$cid,
					'sex' => $sex,
