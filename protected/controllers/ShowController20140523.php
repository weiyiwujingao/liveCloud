...
class ShowController extends Controller
{
	...
	public function actionUploadImg(){
		...
		$CT = Yii::app()->params['system']['ftpCT']['ftpImgUrl'];
		$CNC = Yii::app()->params['system']['ftpCNC']['ftpImgUrl'];
		$this->layout = "//layouts/column3";

		    $images = new Images("file");
			$path = $_POST['path'];
			if ($_GET['act'] == 'cut'){	
				echo '<img id=\'smallImg\' src="'.$path.'" style="display: none; margin:10px;">';
			$image = $path;
//				
...
//				}elseif(is_array($res)){
//					var_dump($res);die;
//					$res['big'] = Yii::app()->params['system']['ftpCT']['ftpHost'].basename($res['big']);
//					$res['small'] = "http://images.cnfol.com/stock/".basename($res['small']);
//					echo '<img src="'.$res['big'].'" style="display: none; margin:10px;">';
//					echo '<img id=\'smallImg\' src="'.$res['big'].'" style="display: none; margin:10px;">';
