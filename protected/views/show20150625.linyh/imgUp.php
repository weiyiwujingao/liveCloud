...
document.domain="cnfol.com";
	...
	<form name="ImgForm" method="post" action="<?php echo yii::app()->createUrl('Show/UploadImg&act=upload');?>" enctype="multipart/form-data">
	...
	<div id="abc" style="overflow: hidden;" >
		...
		<form action="<?php echo yii::app()->createUrl('Show/UploadImg&act=cut');?>" method="post" onsubmit="return checkCoords();">
